...
namespace Tobento\App\FileStorage\Migration;
 ...
 * FileStorage
 */
class FileStorage implements MigrationInterface
{
    /**
     * @var array The files.
     */
    ...
    public function __construct(
        ...
        $this->files = [
            $this->dirs->get('config') => [
                $vendor.'/config/file_storage.php',
            ],
        ];
    }
    ...
    public function install(): ActionsInterface
    {
        return new Actions(
            new FilesCopy(
                files: $this->files,
                type: 'config',
                description: 'File storage config file.',
            ),
        );
    }
